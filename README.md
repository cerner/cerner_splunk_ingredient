...
| app\_root    | String or `:shcluster` or `:master_apps` |              No             | Standard apps directory                     | The root directory to install the app. Given path can be relative (to ${SPLUNK\_HOME}/etc) or absolute. You can give :shcluster or :master\_apps to install the app to those respective cluster configuration locations.                    |
